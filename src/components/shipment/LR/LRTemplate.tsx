    ...
    <Page size="A4" style={styles.page}>
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          <Text style={styles.companyName}>TRIKONA Logistics</Text>
        ...
        <View style={[styles.headerRight, { gap: 5 }]}>
          <Image
            src="https://trikona-bucket.s3.ap-south-1.amazonaws.com/trikona-logo.png"
            style={{
              width: 200,
              height: 50,
              paddingBottom: 5,
      ...
      <View style={styles.signatureSection}>
        ...
        <Text>For Trikona Logistics</Text>
      </View>
